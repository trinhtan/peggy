...
//   try {
//     const web3 = new Web3(window.ethereum);
//     const ethBridgeBankContract = new web3.eth.Contract(
//       BridgeBank.abi,
//       BridgeBank.networks['3'].address
//     );
//     let result = await ethBridgeBankContract.methods.getLatestPrice(oracleAddress).call();
//     return result;
//   } catch (err) {
//     console.log(err);
//     throw err;
